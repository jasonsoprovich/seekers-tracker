...
// members" — same default tier as the rest of /epgp ("epgp.info.edit"), not
// the stricter "epgp.config" the numeric settings use, since this is prose
// about the rules, not the rules themselves.
